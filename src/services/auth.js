...
export const reqWeChatLogin = data =>
  axios({
...
export const reqWxBindPhoneCode = data =>
  axios({
...
//微信绑定手机号
export const reqWxBindPhone = data =>
  axios({
...
//申请验证码重置密码
export const reqResetAuthCode = data =>
  axios({
    url: 'register/phoneVerificationPwd',
    data,
  });
// 验证输入的短信code是否正确
export const reqCheckSMS = data =>
  axios({
